defrecord Reagent.Listener, master: nil, socket: nil, address: nil, port: nil, acceptors: 1, secure: nil, options: [] do
  ...
  def to_options(__MODULE__[address: address, port: port, options: options, secure: nil]) do
